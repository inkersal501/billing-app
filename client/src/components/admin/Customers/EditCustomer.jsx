...
function EditCustomerForm({isOpen, onRequestClose, editData=null}) {
    ...
    const {_id, name, email, phone, address, gstNumber, logoUrl} = editData; 
    const [form, setForm] = useState({_id, name, email, phone, address, gstNumber, logoUrl});
    ...
    const handleForm = async (e) => {
      ...
      const create = await updateCustomer(form, token);
      if(create) {
          onRequestClose();
      }
    }
