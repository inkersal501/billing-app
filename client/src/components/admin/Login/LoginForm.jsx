...
function LoginForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <form onSubmit={handleSubmit} className="w-full max-w-md bg-white shadow-lg border border-gray-200 rounded-xl p-8">
        {/* Heading */}
        <h1 className="text-2xl font-bold text-center text-gray-800">
          BillingPro
        </h1>
        <p className="text-sm text-center text-gray-500 mb-6">
          Admin Login — Manage billing, products, and users
        </p>
